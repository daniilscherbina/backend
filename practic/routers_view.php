<?php
  ...
  $requests_discription = array(
    ...
    4 => 'Выбор информации (АГЕНТЫ, ДОГОВОРЫ) о страховых агентах и договорах, для которых сумма страхования не меньше 200 000 руб',
    1 => 'Выбор информации о страховых агентах, процент вознаграждения для которых находится в диапазоне от 20% до 50%.',
  );
