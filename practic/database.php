...
$requests = array(
  ...
  '1' => "SELECT cl.id AS 'Код клиента', CONCAT(cl.first_name, ' ', cl.last_name, CASE WHEN сд.patronymic IS NOT NULL THEN CONCAT(' ', сд.patronymic) ELSE '' END) AS 'Ф.И.О. клиента', cl.discount AS 'Персональная скидка %' FROM clients cl WHERE last_name = 'Иванов';",
