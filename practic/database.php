...
$requests = array(
  ...
  '2' => "SELECT ia.id AS 'Код агента', CONCAT(ia.first_name, ' ', ia.last_name, ' ', ia.patronymic) AS 'Ф.И.О. агента', ia.bet AS 'Процент вознаграждения' FROM ia WHERE bet >= 20 AND bet <= 50;",
